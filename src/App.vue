...
<template>
  ...
  <nav
    class="flex flex-col text-center content-center  h-28 mb-4 sm:flex-row sm:text-left sm:justify-between py-2 px-6 bg-red-600 text-white  sm:items-baseline w-full">
    <div class="mb-2 self-center sm:mb-0 inner">

      <a href="https://icons8.com/icon/16294/nintendo"
        class="flex flex-row items-center text-2xl no-underline text-grey-darkest font-sans font-bold"><img src="/src/assets/nintendoIcon.png" alt="Icono de nintendo">Amiibo Catalogue</a><br>
    ...
    <div class="sm:mb-0 self-center">
      ...
      <select v-model="seleccionado" name="filtrar" id="filtrar"
        class="bg-red-600 text-white font-bold text-center me-2 border-2 rounded-md border-white appearance-none" @change="filtrar">
      ...
      <input type="button" @click="openCart=true" value="Shopping cart" class="bg-white text-red-600 font-bold rounded-md px-4 py-1 ms-2">
  ...
  <div class=" w-full h-full grid grid-cols-1 gap-2 items-stretch justify-items-center mx-12 md:grid-cols-3 " id="cuerpo">
    ...
    <div v-for="elemento in lista">
      ...
      <div class="w-full max-w-sm bg-red-600 text-white border border-gray-200 rounded-lg shadow">
        <div class="py-4 px-4">
          <img class="p-4 rounded-t-lg bg-white mx-auto h-82" :src="elemento.image" alt="product image" />
        </div>
        <div class="px-5 pb-5">
    ...
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div class="flex mt-3 -mx-2 sm:mt-0">
                <a href="#" class="mx-2 text-sm transition-colors duration-300 hover:text-gray-500 " aria-label="Reddit"> Teams </a>

                <a href="#" class="mx-2 text-sm  transition-colors duration-300 hover:text-gray-500 " aria-label="Reddit"> Privacy </a>

                <a href="#" class="mx-2 text-sm t transition-colors duration-300 hover:text-gray-500" aria-label="Reddit"> Cookies </a>
            </div>
        </div>
    </div>
</footer>
